    ...
    >
      ...
      >
        <input
          ...
          value={nameValue}
          className="bg-bgInput text-[1.2rem] p-4 rounded-md w-full outline-none"
          type="text"
          placeholder="Name"
        />
        <input
        ...
        <textarea
          ...
          value={messageValue}
          className="bg-bgInput text-[1.2rem] resize-none p-4 h-[200px] rounded-md w-full outline-none"
          maxLength="200"
          placeholder="Message"
        />
